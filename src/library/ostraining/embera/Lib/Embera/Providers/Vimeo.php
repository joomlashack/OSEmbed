...
class Vimeo extends \Embera\Adapters\Service
{
    ...
    public function fakeResponse()
    {
        ...
        return array(
            ...
            'title' => 'Unknown title',
            'html' => '<iframe src="http://player.vimeo.com/video/' . $matches['1'] . '" width="{width}" height="{height}" frameborder="0" title="" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>',
        );
    }
}
